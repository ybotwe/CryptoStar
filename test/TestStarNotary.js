...
it('lets a user transfer a star', async() => {
    ...
    await instance.createStar("Awesome Py Star!", starId, { from: user1 });
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    await instance.createStar("Py Star 2", starId, { from: user1 });
    // 2. Call your method lookUptokenIdToStarInfo
    result = await instance.lookUptokenIdToStarInfo(starId);
    // 3. Verify if you Star name is the same
    assert.equal(result, "Py Star 2");
});